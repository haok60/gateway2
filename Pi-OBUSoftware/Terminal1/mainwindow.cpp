...
confmqtt xx;
DbManager x;
//bool a = x.insertdata("14/4/2019",6,66);
//QStringList a = x.getdata(1);
//bool a = x.deletedata(6);
...
//    </Chinh sua code cho UAV>
    ...
    //sendMqttLux(11,150);
//    QString path = "/home/nghiemdinhhao/Desktop/gateway/Pi-OBUSoftware/build/WSAN";
